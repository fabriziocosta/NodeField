...
- chemistry and demo notebook workflows also expect the installed `abstractgraph`, `abstractgraph-ml`, and `abstractgraph-graphicalizer` packages rather than local import shims
