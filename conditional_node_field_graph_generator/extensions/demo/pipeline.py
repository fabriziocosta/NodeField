...
def build_graph_generator(
    ...
    graph_decoder = ConditionalNodeFieldGraphDecoder(
        ...
        solver_threads=decoder_solver_threads,
    ...
    return ConditionalNodeFieldGraphGenerator(
        ...
        oracle_add_edge_repair_budget=oracle_add_edge_repair_budget,
        oracle_use_node_label_cuts=oracle_use_node_label_cuts,
        oracle_use_edge_label_cuts=oracle_use_edge_label_cuts,
        ...
        max_feasibility_seconds_per_sample=max_feasibility_seconds_per_sample,
